  ...
  return (
    <div className="mx-auto max-w-3xl animate-rise"><p className="font-mono-ui text-[10px] uppercase tracking-[.22em] text-primary/70">Настройки</p><h1 className="mt-3 font-display text-6xl font-semibold tracking-[-.04em]">Тихие предпочтения.</h1><p className="mt-4 max-w-md text-sm leading-6 text-muted-foreground">Настройте Listen так, чтобы возвращаться к книгам было естественно.</p>
      <div className="mt-10 space-y-4">
        ...
        <SettingGroup title="О Listen" icon={<Sparkles className="size-8" />}><p className="text-sm leading-6 text-muted-foreground">Listen — личная полка для аудиокниг без шума и случайных рекомендаций. Ваши файлы не покидают устройство.</p><div className="mt-5 flex items-center gap-2 text-[10px] text-muted-foreground"><span className="size-1.5 rounded-full bg-primary" /> Версия 1.0 <span className="mx-1 opacity-40">•</span> Сделано для долгих историй</div></SettingGroup>
      </div>
    </div>
  );
}
