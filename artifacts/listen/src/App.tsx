    ...
    <div className="space-y-6 md:space-y-7">
      <header className="relative animate-rise rounded-[26px] glass px-5 py-4 md:px-6 md:py-5">
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
          <div><p className="font-mono-ui text-[10px] font-bold uppercase tracking-[.22em] text-primary/70">Личная аудиотека</p><h1 className="mt-1 font-display text-4xl font-semibold leading-none tracking-[-.04em] sm:text-5xl">Моя библиотека</h1></div>
