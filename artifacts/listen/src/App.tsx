...
function AppShell({ children, onAdd }: { children: ReactNode; onAdd: () => void }) {
  ...
  return (
    <div className="listen-grain min-h-[100dvh] bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/background.png')" }}>
