...
// 🔥 ИСПРАВЛЕНИЕ 2: ФОН ВОЗВРАЩЕН И НАСТРОЕН
function AppShell({ children, onAdd }: { children: ReactNode; onAdd: () => void }) {
  ...
  return (
    // Добавлены классы bg-cover bg-center bg-no-repeat и style для вашей картинки
    <div className="listen-grain min-h-[100dvh] bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/фон.jpg')" }}>
